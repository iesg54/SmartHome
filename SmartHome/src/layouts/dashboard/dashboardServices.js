...
async function getEnergyCostInfoLastWeek(houseID) {
    const res = await axios.get(`http://localhost:8080/smarthome/private/house/${houseID}/energy/week`, {
        headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
        },
...
async function getEnergyCostInfoLastMonth(houseID) {
    const res = await axios.get(`http://localhost:8080/smarthome/private/house/${houseID}/energy/month`, {
        headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
        },
